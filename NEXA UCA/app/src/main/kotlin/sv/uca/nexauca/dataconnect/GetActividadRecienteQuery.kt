...
public interface GetActividadRecienteQuery :
    ...
    >
{
  ...
  public companion object {
    public val operationName: String = "GetActividadReciente"
...
public fun GetActividadRecienteQuery.ref(
  
    uid: String,limite: Int,
  ...
  ref(
      ...
      GetActividadRecienteQuery.Variables(
        uid=uid,limite=limite,
  
      )
    
  )

public suspend fun GetActividadRecienteQuery.execute(
  ...
  public fun GetActividadRecienteQuery.flow(
    
      uid: String,limite: Int,

  
    
    ): kotlinx.coroutines.flow.Flow<GetActividadRecienteQuery.Data> =
    ref(
